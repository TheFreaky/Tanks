...
import com.thefreak.client.dialogs.WaitDialog;
import com.thefreak.client.display.Display;
...
import com.thefreak.client.utils.ServerConnection.ServerConnection;
import com.thefreak.client.utils.ServerConnection.ServerListener;
import com.thefreak.client.utils.Time;
...
public class Game implements Runnable, ServerListener {
    ...
    public void refreshData(int data) {
        ...
        if (data == Server.START_CODE) {
            start();
            waitDialog.dispose();
        } else if(data == Server.DISCONNECT_CODE) {
            disconnected();
        } else {
            opponentScore = data;
        }
